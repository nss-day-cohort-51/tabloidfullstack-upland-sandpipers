...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'admin', 'Admin', 'Example', 'admin@example.com', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, 'S6r4XHoQxsfN2yxAkzuhsLUgsut2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'colinraymiller', 'Colin', 'miller', 'colinraymiller@gmail.com', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'OUyDghixpXSIzAYT6FBBWhMp84V2');
